...
import { Plus, Edit, Trash2, ListTodo, Calendar, Flag, Repeat, CheckSquare } from 'lucide-react';
        ...
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-2">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 flex items-center gap-1 transition-all"
            ...
            {activeTab === 'rutinitas' && (
                <div>
                     {!impersonatedUser ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {rutinitas.map((rut) => (
                                <div key={rut.id_rutinitas} className={`bg-gradient-to-br from-white to-indigo-50 border border-indigo-100 rounded-xl p-5 shadow-sm hover:shadow-md transition-all`}>
                                    <div className="flex justify-between items-start mb-2">
                                        <h3 className="font-semibold text-indigo-900 text-base leading-snug">{rut.nama}</h3>
                                        <span className={`text-xs px-2 py-0.5 rounded-full font-medium whitespace-nowrap ml-2 bg-indigo-100 text-indigo-700`}>
                                            <Repeat size={10} className="inline mr-1"/>Habit
                                        </span>
                                    </div>
